...
class LocalWordFrequencyDataLoading(WordFrequencyLoader):
    ...
    def load(self) -> WordFrequenciesByCategory:
        ...
        with open(self._file_path, 'r', encoding='utf-8') as file:
            data = json.load(file)
        return WordFrequenciesByCategory(preprocessed=data["word_frequency_preprocessed"],
...
class ApiWordFrequencyDataLoading(WordFrequencyLoader):
    ...
    def load(self) -> WordFrequenciesByCategory:
        ...
        word frequencies and the classical one
        """
        return WordFrequenciesByCategory(preprocessed=self._post_request_data["word_frequency_preprocessed"],
